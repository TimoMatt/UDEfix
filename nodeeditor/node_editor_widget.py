...
class NodeEditorWidget(QWidget):
    ...
    def addNodes(self):
        node1 = Node(self.scene, "New Node 1", inputs=[0, 0, 0], outputs=[1])
        node2 = Node(self.scene, "New Node 2", inputs=[3, 3, 3], outputs=[1])
        node3 = Node(self.scene, "New Node 3", inputs=[2, 2, 2], outputs=[1])
